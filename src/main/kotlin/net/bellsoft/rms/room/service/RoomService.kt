...
class RoomService(
    ...
    fun findHistory(id: Long, pageable: Pageable): EntityListDto<EntityRevisionDto<RoomDetailDto>> = EntityListDto
        .of(entityRevisionComponent.findAllHistory<Room, RoomDetailDto>(Room::class, roomMapper::toDto, id, pageable))
