package net.bellsoft.rms.user.service.impl
...
class UserServiceImpl(
    ...
    @Transactional
    override fun register(userCreateDto: UserCreateDto): UserDetailDto {
        try {
    ...
    override fun findAll(pageable: Pageable): EntityListDto<UserDetailDto> {
        return EntityListDto.of(userRepository.findAll(pageable), userMapper::toDto)
    }

    @Transactional
    override fun updateAccount(updateUserId: Long, userPatchDto: UserPatchDto): UserDetailDto {
    ...
    override fun isUpdatableAccount(requestUser: User, targetUserId: Long): Boolean {
